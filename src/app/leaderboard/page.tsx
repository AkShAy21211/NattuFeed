      ...
      <div className="bg-white px-4 pt-10 pb-0 rounded-b-[2.5rem] shadow-sm overflow-hidden">
        ...
        */}
        ...
        <div className="flex items-end justify-center gap-2 sm:gap-4 w-full max-w-sm mx-auto mt-0">
          <div className="flex-1 h-6 bg-gray-100 rounded-t-xl" />
          <div className="flex-1 h-10 bg-primary/10 rounded-t-xl" />
          <div className="flex-1 h-4 bg-gray-100 rounded-t-xl" />
        </div>
      </div>
      ...
      {!isUserInTop10 && userRank && (
        <div className="fixed bottom-24 inset-x-0 px-4 z-40 pointer-events-none">
          <div className="
            ...
            bg-gray-900/95 backdrop-blur-xl text-white
          ...
          ">
            {/* icon */}
            <div className="w-11 h-11 bg-primary/20 rounded-xl flex items-center justify-center border border-primary/30 shrink-0">
              <Trophy className="w-5 h-5 text-primary fill-primary/40" />
            </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[15px] font-black leading-tight truncate">
                ...
                <span className="text-white/30 text-xs font-bold mx-1.5">·</span>
                {userWeeklyPoints}
                <span className="text-white/30 text-[10px] font-bold ml-1 uppercase">{t('points')}</span>
              </p>
              {userRank > 1 && (
                <p className="text-[9px] font-bold text-white/30 uppercase tracking-widest mt-0.5">
                  {t('ptsToReach', { pts: String(pointsToNext(userWeeklyPoints, userRank)), rank: String(userRank - 1) })}
                </p>
              )}
            </div>

            {/* cta */}
            <div className="flex items-center gap-1.5 bg-white/5 border border-white/10 px-3 py-1.5 rounded-xl shrink-0">

...
export const metadata: Metadata = {
  metadataBase: new URL("https://nattufeed-d59c9.web.app/"),
  title: {
  ...
  openGraph: {
    type: "website",
    locale: "en_IN",
    url: "https://nattufeed-d59c9.web.app/",
    siteName: "NattuFeed",
    images: [
      {
        url: "/logo.png",
        width: 1200,
        height: 630,
        alt: "NattuFeed - Hyperlocal Kerala Feed",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "NattuFeed - Hyperlocal Kerala Feed",
    description: "The heartbeat of your neighborhood. Real-time local updates for Kerala.",
    images: ["/logo.png"],
    creator: "@nattufeed",
  },
  appleWebApp: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${dmSans.variable} ${notoMalayalam.variable}`} suppressHydrationWarning>

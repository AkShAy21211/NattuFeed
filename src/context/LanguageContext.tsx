...
const translations: Record<string, Record<Language, string>> = {
  ...
  local: { en: "Local", ml: "ലോക്കൽ" },
  viewGlobal: { en: "View Kerala", ml: "കേരളം മുഴുവൻ കാണുക" },
  km: { en: "km", ml: "കി.മീ" },
  ...
  postUpdate: { en: "Post Update", ml: "പുതിയ വിവരം പങ്കുവെക്കുക" },
  ...
  termsOfService: { en: "Terms of Service", ml: "നിബന്ധനകൾ" },
  ...
  nativeMember: { en: "Helpful Local", ml: "സഹായ മനസ്ഥിതിയുള്ള നാട്ടുകാരൻ" },
  ...
  hintTraffic: { en: "Bus late, KSRTC, road block, accident, railway cross", ml: "ബസ് വൈകി, KSRTC, റോഡ് ബ്ലോക്ക്, അപകടം" },
  hintUtility: { en: "Power cut, KSEB, pipe burst, waste dumping, light", ml: "കറന്റ് പോയി, പൈപ്പ് പൊട്ടി, മാലിന്യം, സ്ട്രീറ്റ് ലൈറ്റ്" },
  hintMarket: { en: "Fish/veg price, shop open/closed, fresh catch, chanda", ml: "മീൻ/പച്ചക്കറി വില, കട തുറന്നോ, ചന്ത വിശേഷങ്ങൾ" },
  hintServices: { en: "Coconut climber, home nurse, electrician, plumber, driver", ml: "തെങ്ങുകയറ്റം, ഹോം നഴ്സ്, ഇലക്ട്രീഷ്യൻ, ഡ്രൈവർ" },
  hintHealth: { en: "Blood needed, ambulance, PHC, pharmacy, doctor", ml: "രക്തം വേണം, ആംബുലൻസ്, ഹോസ്പിറ്റൽ, മരുന്ന്" },
  hintAlerts: { en: "Hartal, heavy rain, festival, stray dog, event", ml: "ഹർത്താൽ, മഴ മുന്നറിയിപ്പ്, ഉത്സവം, തെരുവുനായ" },
  ...
  statusNovice: { en: "Novice", ml: "തുടക്കക്കാരൻ" },
  statusActive: { en: "Active Member", ml: "സജീവ അംഗം" },
  statusHero: { en: "Neighborhood Hero", ml: "നാട്ടിലെ താരം" },
  statusPath: { en: "Pathfinder", ml: "വഴികാട്ടി" },
  statusGuardian: { en: "Guardian", ml: "കാവൽക്കാരൻ" },
  levelLabel: { en: "Level", ml: "നിലവാരം" },
  loadingRankings: { en: "Loading rankings...", ml: "റാങ്കിംഗ് ലോഡ് ചെയ്യുന്നു..." },
  topNattukarans: { en: "Top Nattukarans", ml: "മുൻനിരക്കാർ" },
  ...
  updateIdentity: { en: "Update Identity", ml: "വിവരങ്ങൾ പുതുക്കുക" },
  ...
  guardianTitle: { en: "Guardian of NattuFeed", ml: "നട്ടുഫീഡിന്റെ കാവൽക്കാരൻ" },
  ...
  citizen: { en: "Citizen", ml: "നാട്ടുകാരൻ" },
  ...
  install: { en: "Install", ml: "ഇന്റർൾ" },
  installiOS: { en: "Install NattuFeed", ml: "നട്ടുഫീഡ് ഇൻസ്റ്റാൾ ചെയ്യുക" },
  installiOSDesc: { en: "Add to Home Screen for a native app experience.", ml: "ആപ്പിന്റെ അനുഭവം ലഭിക്കാൻ ഹോം സ്ക്രീനിലേക്ക് ചേർക്കുക." },
